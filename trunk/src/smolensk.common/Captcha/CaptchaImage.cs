...
namespace smolensk.common.Captcha
{
    ...
    public class CaptchaImage
    {
        ...
        /// </summary>
        /// <param name="fieldName">Имя поля, хранящего код</param>
        /// <param name="deleteCache">Признак удаление кеша</param>
        /// <returns></returns>
        public static CaptchaImage GetCachedCaptcha(string fieldName, bool deleteCache = false)
        {
            string guid = HttpContext.Current.Request.Form[fieldName];

            if (String.IsNullOrEmpty(guid))
                return null;

            var result = (CaptchaImage)HttpRuntime.Cache.Get(guid);
        ...
        /// </summary>
        /// <param name="fieldName">Имя поля, хранящего код</param>
        /// <param name="ctx">Текущий HttpContext</param>
        /// <param name="deleteCache">Признак удаление кеша</param>
        /// <returns></returns>
        public static CaptchaImage GetCachedCaptcha(string fieldName, HttpContextBase ctx, bool deleteCache = false)
        {
            string guid = ctx.Request.QueryString[fieldName];
