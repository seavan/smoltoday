...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.photobank_related_photos>()
        ...
        .Select("_Select", "admin_photobank_related_photos") 
        .Delete("_Delete", "admin_photobank_related_photos")
        .Update("_Update", "admin_photobank_related_photos")
        .Insert("_Insert", "admin_photobank_related_photos") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_photobank_related_photos").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
