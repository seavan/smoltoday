...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.blogs>()
        .Name("t_meridian.smolenskList")
        .DataBinding(dataBinding => dataBinding.Ajax()
        .Select("_Select", "admin_blogs") 
        .Delete("_Delete", "admin_blogs")
        .Update("_Update", "admin_blogs")
        .Insert("_Insert", "admin_blogs") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_blogs").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
