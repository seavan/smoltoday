...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.photobank_photo_prices>()
        .Name("t_meridian.smolenskList")
        .DataBinding(dataBinding => dataBinding.Ajax()
        .Select("_Select", "admin_photobank_photo_prices") 
        .Delete("_Delete", "admin_photobank_photo_prices")
        .Update("_Update", "admin_photobank_photo_prices")
        .Insert("_Insert", "admin_photobank_photo_prices") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_photobank_photo_prices").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
