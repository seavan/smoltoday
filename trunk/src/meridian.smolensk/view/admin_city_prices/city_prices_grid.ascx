...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.city_prices>()
        ...
        .Select("_Select", "admin_city_prices") 
        .Delete("_Delete", "admin_city_prices")
        .Update("_Update", "admin_city_prices")
        .Insert("_Insert", "admin_city_prices") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_city_prices").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
