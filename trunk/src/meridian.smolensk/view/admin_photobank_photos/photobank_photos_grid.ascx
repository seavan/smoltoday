...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.photobank_photos>()
        .Name("t_meridian.smolenskList")
        .DataBinding(dataBinding => dataBinding.Ajax()
        .Select("_Select", "admin_photobank_photos") 
        .Delete("_Delete", "admin_photobank_photos")
        .Update("_Update", "admin_photobank_photos")
        .Insert("_Insert", "admin_photobank_photos") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_photobank_photos").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
