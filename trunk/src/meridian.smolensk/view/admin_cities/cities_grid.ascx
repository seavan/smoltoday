...
<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<IEnumerable<meridian.smolensk.proto.cities>>" %>
<div style="padding-top: 30px; margin-top: 10px;  border-top: 1px dotted silver;" >
<%

    Html.Telerik().Grid<meridian.smolensk.proto.cities>()
        .Name("t_meridian.smolenskList")
        .DataBinding(dataBinding => dataBinding.Ajax()
        .Select("_Select", "admin_cities") 
        .Delete("_Delete", "admin_cities")
        .Update("_Update", "admin_cities")
        .Insert("_Insert", "admin_cities") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_cities").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
