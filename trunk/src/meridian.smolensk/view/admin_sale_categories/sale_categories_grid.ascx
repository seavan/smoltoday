...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.sale_categories>()
        ...
        .Select("_Select", "admin_sale_categories") 
        .Delete("_Delete", "admin_sale_categories")
        .Update("_Update", "admin_sale_categories")
        .Insert("_Insert", "admin_sale_categories") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_sale_categories").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
