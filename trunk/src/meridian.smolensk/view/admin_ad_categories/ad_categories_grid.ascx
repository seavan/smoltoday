...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.ad_categories>()
        ...
        .Select("_Select", "admin_ad_categories") 
        .Delete("_Delete", "admin_ad_categories")
        .Update("_Update", "admin_ad_categories")
        .Insert("_Insert", "admin_ad_categories") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_ad_categories").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
