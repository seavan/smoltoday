...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.sale_types>()
        ...
        .Select("_Select", "admin_sale_types") 
        .Delete("_Delete", "admin_sale_types")
        .Update("_Update", "admin_sale_types")
        .Insert("_Insert", "admin_sale_types") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_sale_types").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
