...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.actions>()
        ...
        .Select("_Select", "admin_actions") 
        .Delete("_Delete", "admin_actions")
        .Update("_Update", "admin_actions")
        .Insert("_Insert", "admin_actions") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_actions").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
