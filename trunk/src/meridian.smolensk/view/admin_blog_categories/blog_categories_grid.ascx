...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.blog_categories>()
        ...
        .Select("_Select", "admin_blog_categories") 
        .Delete("_Delete", "admin_blog_categories")
        .Update("_Update", "admin_blog_categories")
        .Insert("_Insert", "admin_blog_categories") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_blog_categories").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
