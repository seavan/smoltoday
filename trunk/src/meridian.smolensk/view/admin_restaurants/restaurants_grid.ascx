...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.restaurants>()
        ...
        .Select("_Select", "admin_restaurants") 
        .Delete("_Delete", "admin_restaurants")
        .Update("_Update", "admin_restaurants")
        .Insert("_Insert", "admin_restaurants") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_restaurants").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
