...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.company_kind_activities>()
        ...
        .Select("_Select", "admin_company_kind_activities") 
        .Delete("_Delete", "admin_company_kind_activities")
        .Update("_Update", "admin_company_kind_activities")
        .Insert("_Insert", "admin_company_kind_activities") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_company_kind_activities").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
