...
<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<IEnumerable<meridian.smolensk.proto.places>>" %>
<div style="padding-top: 30px; margin-top: 10px;  border-top: 1px dotted silver;" >
<%

    Html.Telerik().Grid<meridian.smolensk.proto.places>()
        .Name("t_meridian.smolenskList")
        .DataBinding(dataBinding => dataBinding.Ajax()
        .Select("_Select", "admin_places") 
        .Delete("_Delete", "admin_places")
        .Update("_Update", "admin_places")
        .Insert("_Insert", "admin_places") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_places").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
