...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.companies>()
        ...
        .Select("_Select", "admin_companies") 
        .Delete("_Delete", "admin_companies")
        .Update("_Update", "admin_companies")
        .Insert("_Insert", "admin_companies") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_companies").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
