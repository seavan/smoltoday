...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.restaurant_entry_categories>()
        ...
        .Select("_Select", "admin_restaurant_entry_categories") 
        .Delete("_Delete", "admin_restaurant_entry_categories")
        .Update("_Update", "admin_restaurant_entry_categories")
        .Insert("_Insert", "admin_restaurant_entry_categories") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_restaurant_entry_categories").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
