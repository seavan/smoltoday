...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.restaurant_comments>()
        ...
        .Select("_Select", "admin_restaurant_comments") 
        .Delete("_Delete", "admin_restaurant_comments")
        .Update("_Update", "admin_restaurant_comments")
        .Insert("_Insert", "admin_restaurant_comments") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_restaurant_comments").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
