...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.accounts>()
        ...
        .Select("_Select", "admin_accounts") 
        .Delete("_Delete", "admin_accounts")
        .Update("_Update", "admin_accounts")
        .Insert("_Insert", "admin_accounts") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_accounts").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
