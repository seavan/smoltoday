...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.actions_comments>()
        ...
        .Select("_Select", "admin_actions_comments") 
        .Delete("_Delete", "admin_actions_comments")
        .Update("_Update", "admin_actions_comments")
        .Insert("_Insert", "admin_actions_comments") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_actions_comments").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
