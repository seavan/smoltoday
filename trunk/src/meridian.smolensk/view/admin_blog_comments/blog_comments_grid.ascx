...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.blog_comments>()
        ...
        .Select("_Select", "admin_blog_comments") 
        .Delete("_Delete", "admin_blog_comments")
        .Update("_Update", "admin_blog_comments")
        .Insert("_Insert", "admin_blog_comments") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_blog_comments").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
