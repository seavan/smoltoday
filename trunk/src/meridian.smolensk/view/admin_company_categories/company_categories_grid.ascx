...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.company_categories>()
        ...
        .Select("_Select", "admin_company_categories") 
        .Delete("_Delete", "admin_company_categories")
        .Update("_Update", "admin_company_categories")
        .Insert("_Insert", "admin_company_categories") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_company_categories").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
