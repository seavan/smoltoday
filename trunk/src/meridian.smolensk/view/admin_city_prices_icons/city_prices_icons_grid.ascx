...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.city_prices_icons>()
        ...
        .Select("_Select", "admin_city_prices_icons") 
        .Delete("_Delete", "admin_city_prices_icons")
        .Update("_Update", "admin_city_prices_icons")
        .Insert("_Insert", "admin_city_prices_icons") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_city_prices_icons").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
