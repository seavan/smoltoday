...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.genres>()
        ...
        .Select("_Select", "admin_genres") 
        .Delete("_Delete", "admin_genres")
        .Update("_Update", "admin_genres")
        .Insert("_Insert", "admin_genres") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_genres").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
