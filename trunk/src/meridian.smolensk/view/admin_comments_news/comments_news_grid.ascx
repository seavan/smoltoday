...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.comments_news>()
        ...
        .Select("_Select", "admin_comments_news") 
        .Delete("_Delete", "admin_comments_news")
        .Update("_Update", "admin_comments_news")
        .Insert("_Insert", "admin_comments_news") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin_comments_news").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
