...
{
	[MetadataType(typeof(actions_comments_meta))]	public partial class actions_comments : admin.db.IDatabaseEntity
	{
		public actions_comments()
		{
		}
		private long m_id = 0;
		...
		public void LoadAggregations(Meridian _meridian)
		{
			...
			{
				this.c_actions_actions = _meridian.actionsStore.Get(action_id);;
				this.c_actions_actions.AddActionComment(this);
			}
		}
		public void DeleteAggregations()
		{
			if(this.c_actions_actions != null)
			{
				this.c_actions_actions.RemoveActionComment(this);
			}
		}
		...
		{
			get { return "actions_comments"; }
		}
		/* metafile template 
		internal class actions_comments_meta
		{
		...
		private actions c_actions_actions
		{
			get; set; 
		}
		public actions GetActionCommentAction()
		{
			return c_actions_actions ;
		}
	}
}
