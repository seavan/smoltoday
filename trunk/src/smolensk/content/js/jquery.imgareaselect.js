...
$.imgAreaSelect = function (img, options) {
    ...
    function viewX(x){   return x + round($img.offset().left) - parOfs.left; }
    function viewY(y){   return y + round($img.offset().top) - parOfs.top; }
    function selX(x){    return x - round($img.offset().left) + parOfs.left; }
    function selY(y){    return y - round($img.offset().top) + parOfs.top; }
...
/*
        parOfs = $.inArray($parent.css('position'), ['absolute', 'relative']) + 1 ?
            ...
            position == 'fixed' ?
                ...
                { left: 0, top: 0 };
*/
//console.log('top: ' + imgOfs.top + ' / left: ' + imgOfs.left)
//console.log('top: ' + parOfs.top + ' / left: ' + parOfs.left)
//parOfs = $parent.offset();
        //parOfs.left=0;
        //parOfs.top=0;
