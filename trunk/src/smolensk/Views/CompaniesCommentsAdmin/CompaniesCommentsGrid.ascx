...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.company_comments>()
        ...
        .Select("_Select", "CompaniesCommentsAdmin") 
        .Update("_Update", "CompaniesCommentsAdmin")
        .Insert("_Insert", "CompaniesCommentsAdmin")        
        .Delete("_Delete", "CompaniesCommentsAdmin")
        )
