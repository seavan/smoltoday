<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<smolensk.Models.ViewModels.Mail.ResumeSendModel>" %>
...
<div class="enterForm send_resume _closest">
    ...
    <small><b>Компания:</b> <%: Model.Vacancy.GetVacanciesCompanie().title %></small>
                            
    <% using (Html.BeginForm("ResumeSend", "Vacancy"))
       {%>
