...
<asp:Content ID="Content1" ContentPlaceHolderID="Poster" runat="server">
    ...
    <div class="moreList">
        ...
        <ul class="moreSelector">
            <li>Места</li>
            <li class="cur">События</li>
        </ul>
        
        <% Html.RenderAction("PlacesList", new { id = Model.Category.Id, from = Model.Date.From, to = Model.Date.To }); %> 
        <% Html.RenderAction("ActionsList", new { id = Model.Category.Id, from = Model.Date.From, to = Model.Date.To }); %>                  
    </div>
