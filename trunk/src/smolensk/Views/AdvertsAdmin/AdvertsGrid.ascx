...
<%
    ...
    Html.Telerik().Grid<meridian.smolensk.proto.ad_advertisments>()
        ...
        .Select("_Select", "AdvertsAdmin") 
        .Delete("_Delete", "AdvertsAdmin")
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.created_date);
                    c.Bound(col => col.in_interesting);
                    c.Bound(col => col.on_main);
                    c.Bound(col => col.price);
                    ...
                    c.Bound(col => col.id).Edit("AdvertsAdmin").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
